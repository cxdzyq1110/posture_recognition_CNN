...
vlog -incr  	   "../01_altera_ip/cnn_scfifo_256pts/cnn_scfifo_256pts.v"    
...
vlog -incr  	   "../01_altera_ip/alt_lpm_div_ip/alt_lpm_div_ip.v"    
vlog -incr  	   "../01_altera_ip/cnn_ram_256pts/cnn_ram_256pts.v"    
vlog -incr  	   "../01_altera_ip/cnn_inst_ram/cnn_inst_ram.v"    
...
vlog -incr  	   "../00_user_logic/cnn_inst_executor.v"                        
vlog -incr  	   "../00_user_logic/cnn_inst_parser.v"                        
vlog -incr  	   "../00_user_logic/int_cordic_exp_rtl.v"                        
vlog -incr  	   "../00_user_logic/int_cordic_tanh_sigm_rtl.v"                        
vlog -incr  	   "../00_user_logic/top.v"                        
vlog -incr  	   "../00_user_logic/tb.v"                 
vlog -incr  	   "../00_user_logic/tb_cnn.v"                 
}
# --------------------
