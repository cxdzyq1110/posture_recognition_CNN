copy /Y ..\..\08_quartus\output_files\pr_dl.sof .\DE10_Nano_Default.sof
@echo off
 @ REM ######################################
...
:DownLoad
 ...
 set project.rbf=DE10_Nano_Default.rbf
...
echo Plesase choose your operation
 ...
 echo "2" for converting .sof to .jic  and .rbf
