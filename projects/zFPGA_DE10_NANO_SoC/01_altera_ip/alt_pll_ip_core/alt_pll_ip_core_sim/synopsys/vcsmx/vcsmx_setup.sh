...
# ACDS 14.0 200 win32 2018.04.18.17:00:22
...
TOP_LEVEL_NAME="alt_pll_ip_core"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="F:/altera/14.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k "$QSYS_SIMDIR/alt_pll_ip_core.vo"
fi
