...
void merge_bbox_task(void)
{
    ...
    int Tx_max = (cx+of_bbox_shifter_sum[2]/2/of_bbox_shifter_len)>(CAM_H_WIDTH-4*BBOX_WIDTH) ? (CAM_H_WIDTH-4*BBOX_WIDTH) : cx+of_bbox_shifter_sum[2]/2/of_bbox_shifter_len;
    int Ty_min = (cy-of_bbox_shifter_sum[3]/2/of_bbox_shifter_len)<0 ? 0 : cy-of_bbox_shifter_sum[3]/2/of_bbox_shifter_len;
    int Ty_max = (cy+of_bbox_shifter_sum[3]/2/of_bbox_shifter_len)>(CAM_V_WIDTH-4*BBOX_WIDTH) ? (CAM_V_WIDTH-4*BBOX_WIDTH) : cy+of_bbox_shifter_sum[3]/2/of_bbox_shifter_len;
    //
